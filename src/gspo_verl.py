...
class GSPOAgentPolicy:
    ...
    def _print_trainable_summary(self):
        ...
        role = "pi0" if self.is_coop else "pi1"
        extra = (
    ...
    def _build_generate_kwargs(self, stage, num_return_sequences, return_dict_in_generate, output_scores):
    ...
    def act(self, query_context, prompt_override=None):
        ...
        try:
            ...
            for row_idx in range(sequences.shape[0]):
                ...
                full_input_ids = sequences[row_idx, :total_len].unsqueeze(0)
    ...
    def sample_text_batch(self, query_contexts, prompt_override=None):
        ...
        try:
            ...
            for row_idx, input_len in enumerate(input_lens):
                generated_ids = outputs[row_idx][int(input_len):]
                results.append(
    ...
    def update_from_cached(self, batch, rewards):
        ...
        try:
            ...
            (
                ...
                old_log_probs,
                old_seq_lens,
            ) = self._collate_cached_candidates(candidates)
